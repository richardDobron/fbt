...
namespace fbt\Util\SimpleHtmlDom;
...
class Node
{
    ...
    {
        return strstr($this->_[HDOM_INFO_ENDSPACE], '/');
    }

    public function isNamespacedElement(): bool
    {
        return strstr($this->tag, ':');
    }

    public function isElement(): bool
    {
        return $this->nodetype === HDOM_TYPE_ELEMENT;
    }

    public function isComment(): bool
    {
        return $this->nodetype === HDOM_TYPE_COMMENT;
    }

    public function isText(): bool
    {
        return $this->nodetype === HDOM_TYPE_TEXT;
    }
...
class DOM
{
    ...
    public function isSelfClosingTag(string $tag): bool
    {
        return array_key_exists(strtolower($tag), $this->self_closing_tags);
    }
}
