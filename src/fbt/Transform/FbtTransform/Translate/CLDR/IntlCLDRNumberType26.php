...
class IntlCLDRNumberType26 implements IntlNumberConsistency
{
    ...
    public function getExample(int $variation): ?string
    {
        $examples = [
            ...
            IntlVariations::INTL_NUMBER_VARIATIONS['MANY'] => "a number like 0, 5~19, 100, 1000, 10000, 100000, 1000000, …",
        ];
    ...
    public function getVariation($n): int
    {
        ...
        if (fmod($n, 10) >= 2 && fmod($n, 10) <= 4 && (fmod($n, 100) < 12 || fmod($n, 100) > 14)) {
